...
Me.skills = "JavaScript, HTML, Python";

/* Ex.G 
   Programmatically remove the last skill from the array "skills" inside of the "me" object
*/

const array = Me.skills.split(" ");
array.pop();
...
const SplitMe = function (str0) {
  return str0.split(" ");
};

let str0 = "I love coding";
...
let str1 = "I am a human";
let boo = false;

let splitter = str1.split("");

const DeleteOne = function (str1, boo) {
  if (boo === true) {
    let FirstChar = splitter.slice(1, 12);
    let FinalStr = FirstChar.join("");
    return FinalStr;
  }
  if (boo === false) {
    let LastChar = splitter.slice(0, 11);
    let FinalStr = LastChar.join("");
    return FinalStr;
  } else {
    return null;
  }
...
str2 = "I 3324 love 123 whatever";

const OnlyLetters = function (str2) {
  let noNum = str2.replace(/[0-9]/g, "");
  return noNum;
};
